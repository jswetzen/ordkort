# Generate mellan word batch 2 (remaining domains)
...
Cover ONLY these 10 domains for this batch, roughly evenly (~19 words each): platser & byggnader, kroppsdelar, fordon & transport, väder & årstider, kläder, musik & instrument, skolan, familj & högtider, sagor & fantasi, abstrakta begrepp & samhälle (keep this last domain light and general — everyday abstract ideas, not politics or religion).
...
3. Family-friendly (a child could draw this from a deck) — no violent, sexual, or offensive content, and avoid heavy political/religious topics entirely for the abstrakta-domain words — keep those light (e.g. everyday concepts like "rutin", "vardag", "överraskning") not ideology.
...
/tmp/claude-1000/-home-johan-git-mikro-iac/39db4bbe-cd7f-4293-a6de-4ae6ec8dad7a/scratchpad/mellan-batch-2.json
